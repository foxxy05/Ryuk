...
//    	float PWM1 = constrain(((vel*cos(angle) - (length*omega))) / radius , -LINEAR_PWM, LINEAR_PWM);
//    	float PWM2 = constrain(((sqrt(3)*vel*sin(angle) - vel*cos(angle) - 2*length*omega) / (2*radius)), -LINEAR_PWM, LINEAR_PWM);
//    	float PWM3 = constrain((-1*((vel*cos(angle) + sqrt(3)*vel*sin(angle) + 2*length*omega) / (2*radius))), -LINEAR_PWM, LINEAR_PWM);
...
//    	pwm3 = constrain(  PWM3 + CORRECTION, -MAX_PWM, MAX_PWM);
    	       ...
    	       pwm1 = constrain(   CORRECTION , -MAX_PWM, MAX_PWM);
    	    	pwm2 = constrain(   CORRECTION , -MAX_PWM, MAX_PWM);
    	    	pwm3 = constrain(   CORRECTION , -MAX_PWM, MAX_PWM);
