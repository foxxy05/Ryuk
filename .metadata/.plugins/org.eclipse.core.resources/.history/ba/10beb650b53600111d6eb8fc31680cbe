...
int main(void) {
	...
	while (1) {
		...
		float voltage1 = ch1_mV / 1000.0f;
		float dist1 = ((voltage1 - 0.21f) / 4.96f) * total_dis; //Sick 2
		float voltage2 = ch2_mV / 1000.0f;
		float dist2 = ((voltage2 - 0.36f) / 4.77f) * total_dis; //Sick 3
		...
		// Split floats into integer + decimal parts
		int dist_int1 = (int) dist1;
		int dist_dec1 = (int) ((dist1 - dist_int1) * 10);     // 1 decimal place

		// Split floats into integer + decimal parts
		int dist_int2 = (int) dist2;
		int dist_dec2 = (int) ((dist2 - dist_int2) * 10);     // 1 decimal place
