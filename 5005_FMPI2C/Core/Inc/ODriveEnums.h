...
#ifndef INC_ODRIVEENUMS_H_
#define INC_ODRIVEENUMS_H_
...
}ODriveStreamProtocolType;

// ODrive.Can.Protocol
typedef enum ODriveProtocol {
    PROTOCOL_NONE                            = 0x00000000,
    PROTOCOL_SIMPLE                          = 0x00000001,
}ODriveProtocol;

// ODrive.Axis.AxisState
typedef enum ODriveAxisState {
...
typedef enum ODriveControlMode {
...
typedef enum ODriveComponentStatus {
...
}ODriveComponentStatus;

// ODrive.Error
typedef enum ODriveError {
...
typedef enum ODriveProcedureResult {
...
typedef enum ODriveSpiEncoderMode {
...
}ODriveSpiEncoderMode;

// ODrive.Rs485EncoderMode
typedef enum ODriveRs485EncoderMode {
...
}ODriveRs485EncoderMode;

// ODrive.Controller.InputMode
typedef enum ODriveInputMode {
